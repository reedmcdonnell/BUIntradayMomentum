...
#Plot strategies
plot <- ggplot() +
  geom_line(data = data, aes(x = Date, y = BenchmarkRet, colour = 'Benchmark Long Strategy')) + 
...
plot <- ggplot() +
  geom_line(data = data, aes(x = Date, y = BenchmarkRetCumRet, colour = 'Benchmark Long Strategy')) + 
  geom_line(data = data, aes(x = Date, y = Strat1CumRet, colour = 'Long/Short Strategy')) + 
...
rollRegCols <- c('Date', bestVars, 'Type', 'Lookback')
